...
def test_scf():
    ...
    graphtopo.assert_check(np.isclose(optimizer.energy, -34.6367, atol = 1E-4))
    graphtopo.assert_check(np.isclose(optimizer.energy_all['SUB_0'], -0.2489, atol = 1E-4))
    graphtopo.assert_check(np.isclose(optimizer.energy_all['SUB_1'], -0.2489, atol = 1E-4))
    ...
    optimizer.optimize()
    graphtopo.assert_check(np.isclose(optimizer.energy, -26.2965, atol = 1E-4))
